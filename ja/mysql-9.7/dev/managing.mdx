...
両方の名前は一致している必要があり、アンダースコアを使用します（[拡張機能の命名規則](/ja/mysql-9.7/dev/install#extension-naming-conventions) を参照）:
...
<Note>
  ...
  と同じゲートです。[必要な権限](/ja/mysql-9.7/dev/install#required-privilege)
  を参照してください。
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    title="拡張機能のアンインストール"
    icon="trash"
    href="/ja/mysql-9.7/dev/uninstall"
  >
    拡張機能を安全に削除
  </Card>
  <Card
