...
このページは、C++タイプ操作ビルダーのリファレンスです。カスタムタイプのチュートリアルレベルの導入については、[C++でのカスタム型](/ja/mysql-9.7/dev/custom-types)を参照してください。
...
- [C++でのカスタム型](/ja/mysql-9.7/dev/custom-types) — カスタムタイプのチュートリアル導入
- [C++ APIリファレンス](/ja/mysql-9.7/dev/extension-api-reference) — VDFコントラクト、null処理、およびバッファーサイズ
- [C++開発](/ja/mysql-9.7/dev/development) — VDFの作成の詳細、引数と結果のタイプ、集計、可変長引数
