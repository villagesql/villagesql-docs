...
のバージョン変更を追跡します。ワークフローについては [拡張機能の管理](/ja/mysql-9.7/stable/managing) を参照してください。
...
サポートされるのは単一のディレクトリのみです。配置とトラブルシューティングについては、[拡張機能の管理](/ja/mysql-9.7/stable/managing) を参照してください。
...
バージョンで利用可能になる機能について
[タイプ操作](/ja/mysql-9.7/stable/type-operations) と
[C++での拡張機能の作成](/ja/mysql-9.7/stable/create) を参照してください。
...
利用可能なプレビュー機能の一覧と、拡張機能がそれらをどう使うかについては、[プレビュー機能](/ja/mysql-9.7/stable/preview-capabilities) を参照してください。
