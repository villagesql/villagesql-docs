...
<Info>
外部拡張機能をインストールする前に、サーバーで`veb_dir`を構成する必要があります。 [veb_dirの構成](/ja/mysql-9.7/stable/managing#configuring-veb_dir)を参照してください。
</Info>
...
さらにトラブルシューティングについては、[拡張機能の管理](/ja/mysql-9.7/stable/managing)を参照してください。
