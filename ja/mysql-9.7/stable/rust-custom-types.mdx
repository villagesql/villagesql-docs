...
このページでは、まず[Rustでの拡張機能の作成](/ja/mysql-9.7/stable/rust-sdk)を完了していることを前提としています。セットアップ（Cargo.toml、manifest.json、cargo-vsql）は同じです。
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="wrench"
    href="/ja/mysql-9.7/stable/rust-sdk"
  >
  ...
  <Card
    title="C++カスタム型"
    icon="shapes"
    href="/ja/mysql-9.7/stable/custom-types"
  >
