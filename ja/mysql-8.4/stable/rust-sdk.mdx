...
<Note>
C++ を使用する場合は、[C++ で拡張機能を作成する](/ja/mysql-8.4/stable/create) を参照して、C++ SDK の手順を確認してください。
</Note>
...
始める前に、VillageSQL をソースからビルドしてください。拡張機能はサーバーのビルドツリーに対してリンクします。まず [ソースからビルドする](/ja/mysql-8.4/stable/source) ガイドに従ってください。
...
<CardGroup cols={2}>
  <Card
    title="Rust でのカスタム型"
    icon="shapes"
    href="/ja/mysql-8.4/stable/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="flask"
    href="/ja/mysql-8.4/stable/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/ja/mysql-8.4/stable/testing-network"
  >
