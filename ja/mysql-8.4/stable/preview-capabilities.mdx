...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | プレビュー — [カスタムインデックス](/ja/mysql-8.4/stable/custom-indexes)を参照 |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | プレビュー — [カスタムインデックス](/ja/mysql-8.4/stable/custom-indexes)を参照 |
