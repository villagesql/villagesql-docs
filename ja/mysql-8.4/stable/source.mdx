...
**Ubuntu/Debian:**
```bash
sudo apt install bison build-essential cmake libaio-dev libncurses5-dev \
                 libssl-dev libtirpc-dev pkg-config zlib1g-dev
```
...
次に、依存関係をインストールします。
```bash
brew install bison cmake openssl@3 pkgconf
```
