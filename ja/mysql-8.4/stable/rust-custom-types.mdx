...
<Warning>
  ...
  [C++ SDK](/ja/mysql-8.4/0.0.5/create)を使用してください。
</Warning>
...
このページでは、まず[Rustでの拡張機能の作成](/ja/mysql-8.4/0.0.5/rust-sdk)を完了していることを前提としています。セットアップ（Cargo.toml、manifest.json、cargo-vsql）は同じです。
...
<CardGroup cols={2}>
  ...
  <Card
    title="C++カスタム型"
    icon="shapes"
    href="/ja/mysql-8.4/0.0.5/custom-types"
  >
