...
バージョンで利用可能になる機能について
[タイプ操作](/ja/mysql-8.4/0.0.5/type-operations) と
[C++での拡張機能の作成](/ja/mysql-8.4/0.0.5/create) を参照してください。
...
利用可能なプレビュー機能の一覧と、拡張機能がそれらをどう使うかについては、[プレビュー機能](/ja/mysql-8.4/0.0.5/preview-capabilities) を参照してください。
