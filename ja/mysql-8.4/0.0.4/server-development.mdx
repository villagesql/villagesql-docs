...
このガイドでは、GDBを使用したデバッグ、サーバーテストスイートの実行、およびVillageSQLへの貢献について説明します。このガイドを使用する前に、[ソースからのビルド](/mysql-8.4/0.0.4/source)を行い、動作するビルドを準備してください。
...
拡張回帰テストの作成については、[開発ガイド](/mysql-8.4/0.0.4/development)を参照してください。
