...
完全な`CustomArg`/`CustomResult`APIについては、[開発ガイド](/mysql-8.4/0.0.4/development#typed-wrappers-recommended)を参照してください。これには、パラメータ化された型用の`CustomArgWith<P>`および`CustomResultWith<P>`が含まれます。
