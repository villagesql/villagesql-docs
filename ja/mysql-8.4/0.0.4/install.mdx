...
<Info>
外部拡張機能をインストールする前に、サーバーで`veb_dir`を構成する必要があります。 [veb_dirの構成](/ja/mysql-8.4/0.0.4/managing#configuring-veb_dir)を参照してください。
</Info>
...
さらにトラブルシューティングについては、[拡張機能の管理](/ja/mysql-8.4/0.0.4/managing)を参照してください。
