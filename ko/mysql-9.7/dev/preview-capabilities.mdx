...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | 미리보기 — [사용자 정의 인덱스](/ko/mysql-9.7/dev/custom-indexes) 참조 |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | 미리보기 — [사용자 정의 인덱스](/ko/mysql-9.7/dev/custom-indexes) 참조 |
