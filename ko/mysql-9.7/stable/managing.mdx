...
두 이름은 밑줄 사용을 포함하여 정확히 동일해야 합니다(참고: [확장 이름 규칙](/ko/mysql-9.7/stable/install#extension-naming-conventions)):
...
<Note>
  ...
  [필수 권한](/ko/mysql-9.7/stable/install#required-privilege)을 참조하세요.
</Note>
...
<CardGroup cols={2}>
  <Card
    title="시스템 참조"
    icon="book"
    href="/ko/mysql-9.7/stable/reference"
  >
    시스템 테이블 및 뷰 쿼리
  </Card>
  <Card
    title="확장 제거"
    icon="trash"
    href="/ko/mysql-9.7/stable/uninstall"
  >
    확장 안전하게 제거
  </Card>
  <Card
