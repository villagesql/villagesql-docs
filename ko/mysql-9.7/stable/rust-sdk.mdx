...
<Note>
C++를 선호하는 경우 [C++로 확장 만들기](/ko/mysql-9.7/stable/create)에서 C++ SDK 워크스루를 참조하세요.
</Note>
...
시작하기 전에 소스에서 VillageSQL을 빌드하세요 — 확장은 서버의 빌드 트리에 링크됩니다. 먼저 [소스에서 빌드](/ko/mysql-9.7/stable/source) 가이드를 따르세요.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="flask"
    href="/ko/mysql-9.7/stable/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/ko/mysql-9.7/stable/testing-network"
  >
