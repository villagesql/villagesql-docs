...
프로토콜 1 VDF 구현은 타입화된 래퍼를 사용하는 대신 원시 C 구조체를 직접 전달할 수 있습니다. 이 스타일은 0.0.5 이후에 제거될 예정입니다 — 모든 새로운 코드에 [타입화된 인자/결과 API](/ko/mysql-8.4/0.0.5/development#argument-and-result-types)를 사용하세요.
