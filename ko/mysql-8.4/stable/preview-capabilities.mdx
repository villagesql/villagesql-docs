...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | 미리보기 — [사용자 정의 인덱스](/ko/mysql-8.4/stable/custom-indexes) 참조 |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | 미리보기 — [사용자 정의 인덱스](/ko/mysql-8.4/stable/custom-indexes) 참조 |
