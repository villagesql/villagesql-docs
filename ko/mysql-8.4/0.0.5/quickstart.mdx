...
개발 또는 맞춤 빌드를 위해, 최신 코드로 직접 컴파일하려면 [소스에서 복제 및 빌드 가이드](/ko/mysql-8.4/0.0.5/source)를 따르세요.
...
자세한 내용은 [확장 설치](/ko/mysql-8.4/0.0.5/install)를 참조하세요.

## 단계 4: 확장된 데이터 타입 사용

이제 확장이 활성화되었으므로, 테이블에서 `COMPLEX` 데이터 타입을 네이티브 타입처럼 사용할 수 있습니다.
...
<CardGroup cols={2}>
  <Card title="확장 관리" icon="puzzle-piece" href="/ko/mysql-8.4/0.0.5/managing">
    다른 확장을 설치하고 관리하는 방법을 배웁니다.
  </Card>
  <Card title="확장 만들기" icon="code" href="/ko/mysql-8.4/0.0.5/create">
