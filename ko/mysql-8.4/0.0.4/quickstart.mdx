...
개발 또는 맞춤 빌드를 위해 [소스에서 복제 및 빌드 가이드](/ko/mysql-8.4/0.0.4/source)를 따르세요.
...
자세한 내용은 [확장 설치](/ko/mysql-8.4/0.0.4/install)를 참조하세요.
...
<CardGroup cols={2}>
  <Card title="확장 관리" icon="puzzle-piece" href="/ko/mysql-8.4/0.0.4/managing">
    다른 확장을 설치하고 관리하는 방법을 배웁니다.
  </Card>
  <Card title="확장 만들기" icon="code" href="/ko/mysql-8.4/0.0.4/create">
