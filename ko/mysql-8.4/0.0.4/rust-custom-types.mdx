...
이 페이지는 이미 [Rust에서 확장 빌드](/ko/mysql-8.4/0.0.4/rust-sdk)를 완료했음을 전제로 합니다. 설정(Cargo.toml, manifest.json, cargo-vsql)은 동일합니다.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Rust에서 확장 빌드"
    icon="wrench"
    href="/ko/mysql-8.4/0.0.4/rust-sdk"
  >
  ...
  <Card
    title="C++ 사용자 정의 타입"
    icon="shapes"
    href="/ko/mysql-8.4/0.0.4/custom-types"
  >
