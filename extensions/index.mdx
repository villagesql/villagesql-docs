...
<Warning>
  When building from source, only `vsql_complex` and `vsql_simple` are included. To get the full set of bundled extensions, use the [install script](/mysql-8.4/0.0.5/quickstart).
</Warning>
