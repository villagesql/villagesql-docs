...
| CIDR insert silently stores NULL for `192.168.1.5/24` (with a warning, not an error) | CIDR requires host bits to be zero — use `192.168.1.0/24`, declare the column `NOT NULL` if bad input should error out, or use INET instead |
