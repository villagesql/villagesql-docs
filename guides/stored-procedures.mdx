...
<Warning>
  ...
  [Uninstalling Extensions](/mysql-8.4/stable/uninstall) for details.
</Warning>
...
- [Uninstalling Extensions](/mysql-8.4/stable/uninstall) — restrictions when stored procedures use extension types
