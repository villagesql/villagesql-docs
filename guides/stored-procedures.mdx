...
<Warning>
  ...
  [Uninstalling Extensions](/mysql-8.4/0.0.4-dev/uninstall) for details.
</Warning>
...
- [Uninstalling Extensions](/mysql-8.4/0.0.4-dev/uninstall) — restrictions when stored procedures use extension types
