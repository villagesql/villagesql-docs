...
sidebarTitle: "Date and Time Functions"
...
```sql
SELECT UNIX_TIMESTAMP();                          -- 1718451000  (seconds since epoch)
SELECT UNIX_TIMESTAMP('2024-06-15 14:30:00');     -- specific datetime to epoch
