...
- [Making HTTP Requests from SQL](/guides/http-requests-in-mysql) — the vsql_http functions used in webhook triggers
- [MySQL Triggers](/guides/triggers) — the trigger mechanics that fire webhooks
- [HMAC Signatures in MySQL](/guides/hmac-mysql) — signing webhook payloads for recipient verification
