...
sidebarTitle: "Inserting in Bulk"
...
These loading techniques work unchanged on [VillageSQL](https://villagesql.com/install), a drop-in replacement for MySQL with extensions.
...
- [UPSERT in MySQL](/guides/upsert) — handling duplicate keys during a load
