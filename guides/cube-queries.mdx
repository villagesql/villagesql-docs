...
Insert the coordinate string directly and let the column's own conversion parse
it. Do not wrap it in `cube_point_nd()`: that returns an unparameterized `cube`,
which cannot be implicitly cast into a dimension-parameterized `cube(3)` column
(`ERROR 3219`).

```sql
INSERT INTO products (name, attrs) VALUES
    ('Budget Widget',   '29.99,4.1,320'),
    ('Standard Widget', '79.99,4.4,1250'),
    ('Premium Widget',  '149.99,4.7,890'),
    ('Discount Widget', '19.99,3.2,45'),
    ('Pro Widget',      '199.99,4.8,2100');
```
