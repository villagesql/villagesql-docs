...
If extensions are what you will miss most from PostgreSQL, [VillageSQL](https://villagesql.com/install) closes that gap: it is a drop-in replacement for MySQL with pgcrypto-compatible functions, INET and UUID types, and an extension framework for building your own.
