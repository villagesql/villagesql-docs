...
- [Read Replicas in MySQL](/guides/read-replicas) — pooling per role when reads and writes split
- [Using MySQL with ORMs: Django, Rails, and Prisma](/guides/mysql-with-orms) — the pools every ORM opens
