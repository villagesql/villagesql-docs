...
- [MySQL vs PostgreSQL: Which Should You Use?](/guides/mysql-vs-postgresql) — how the two databases differ on types and more
- [utf8mb4 in MySQL: Storing Emoji and Full Unicode](/guides/utf8mb4) — column charsets and the four-byte reality
- [Real Booleans in MySQL](/guides/boolean-columns) — a column type that refuses everything except true and false
