...
Every diagnostic on this page works on [VillageSQL](https://villagesql.com/install), a drop-in replacement for MySQL with extensions, so you can adopt it without relearning your tuning workflow.
