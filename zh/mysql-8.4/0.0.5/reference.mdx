...
开发扩展，请参阅 [类型操作](/zh/mysql-8.4/0.0.5/type-operations) 和
[使用 C++ 创建扩展](/zh/mysql-8.4/0.0.5/create)，了解各协议版本提供的功能。
...
有关可用预览功能的列表以及扩展如何使用它们，请参阅[预览功能](/zh/mysql-8.4/0.0.5/preview-capabilities)。
