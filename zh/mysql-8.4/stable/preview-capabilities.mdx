...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | 预览——请参阅[自定义索引](/zh/mysql-8.4/stable/custom-indexes) |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | 预览——请参阅[自定义索引](/zh/mysql-8.4/stable/custom-indexes) |
