...
<Note>
如果您更喜欢 C++，请参阅 [使用 C++ 创建扩展](/zh/mysql-8.4/stable/create)，了解 C++ SDK 的操作指南。
</Note>
...
在开始之前，请先从源代码构建 VillageSQL — 扩展会链接到服务器的构建树。请先按照 [从源代码构建](/zh/mysql-8.4/stable/source) 指南操作。
...
<CardGroup cols={2}>
  ...
  <Card
    title="Rust 中的预览功能"
    icon="flask"
    href="/zh/mysql-8.4/stable/rust-preview-capabilities"
  >
  ...
  <Card
    title="测试依赖网络的扩展"
    icon="network-wired"
    href="/zh/mysql-8.4/stable/testing-network"
  >
