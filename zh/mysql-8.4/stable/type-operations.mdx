...
本页是 C++ 类型操作构建器的参考。有关自定义类型的入门级介绍，请参阅 [C++ 中的自定义类型](/zh/mysql-8.4/stable/custom-types)。
...
- [C++ 中的自定义类型](/zh/mysql-8.4/stable/custom-types) — 自定义类型的入门介绍
- [C++ API 参考](/zh/mysql-8.4/stable/extension-api-reference) — VDF 契约、空值处理和缓冲区大小调整
- [C++ 开发](/zh/mysql-8.4/stable/development) — VDF 编写深度、参数和结果类型、聚合、可变参数
