...
页是 [创建扩展](/zh/mysql-8.4/0.0.4/create)
...
有关完整的 C++ 签名，请参阅 [类型操作构建器](/zh/mysql-8.4/0.0.4/development#type-operation-builders)。
...
有关完整的实现，请参阅 [vsql_complex 示例](/zh/mysql-8.4/0.0.4/examples)。
