...
版本更改。有关工作流程，请参阅 [管理扩展](/zh/mysql-9.7/stable/managing)。
...
仅支持单个目录。有关放置和故障排除，请参阅 [管理扩展](/zh/mysql-9.7/stable/managing)。
...
开发扩展，请参阅 [类型操作](/zh/mysql-9.7/stable/type-operations) 和
[使用 C++ 创建扩展](/zh/mysql-9.7/stable/create)，了解各协议版本提供的功能。
...
有关可用预览功能的列表以及扩展如何使用它们，请参阅[预览功能](/zh/mysql-9.7/stable/preview-capabilities)。
