...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | 预览——请参阅[自定义索引](/zh/mysql-9.7/dev/custom-indexes) |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | 预览——请参阅[自定义索引](/zh/mysql-9.7/dev/custom-indexes) |
