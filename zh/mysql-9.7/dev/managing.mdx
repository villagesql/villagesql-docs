...
两个名称必须完全相同，使用下划线（请参阅[扩展命名约定](/zh/mysql-9.7/dev/install#extension-naming-conventions)）：
...
<Note>
  ...
  请参阅 [所需权限](/zh/mysql-9.7/dev/install#required-privilege)。
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    title="卸载扩展"
    icon="trash"
    href="/zh/mysql-9.7/dev/uninstall"
  >
    安全地删除扩展
  </Card>
  <Card
