...
页是 [在 C++ 中创建扩展](/zh/mysql-9.7/dev/create)
...
有关完整的 C++ 签名，请参阅 [类型操作](/zh/mysql-9.7/dev/type-operations)。
...
有关完整的实现，请参阅 [vsql_complex 示例](/zh/mysql-9.7/dev/examples)。
...
<CardGroup cols={2}>
  <Card
    title="继续：构建您的扩展"
    icon="hammer"
    href="/zh/mysql-9.7/dev/create#step-5-update-build-configuration"
  >
    返回教程，以构建和安装您的扩展。
  </Card>
  <Card
    title="参数化类型"
    icon="sliders"
    href="/zh/mysql-9.7/dev/type-operations#parameterized-types"
  >
  ...
  <Card
    title="扩展 API 参考"
    icon="book"
    href="/zh/mysql-9.7/dev/extension-api-reference"
  >
  ...
  <Card
    ...
    href="/zh/mysql-9.7/dev/managing#replication"
  >
