...
This page is the reference for the C++ type operation builders. For the tutorial-level introduction to custom types, see [Custom Types in C++](/mysql-9.7/dev/custom-types).
...
- [Custom Types in C++](/mysql-9.7/dev/custom-types) — tutorial introduction to custom types
- [C++ API Reference](/mysql-9.7/dev/extension-api-reference) — VDF contracts, null handling, and buffer sizing
- [C++ Development](/mysql-9.7/dev/development) — VDF authoring depth, argument and result types, aggregates, varargs
