...
title: "Introduction"
description: "Welcome to VillageSQL Server for MySQL 9.7.2-0.0.7-dev"
---
...
This version of VillageSQL is compatible with MySQL 9.7.2.
...
<CardGroup cols={1}>
  <Card title="Quickstart Guide" icon="bolt" href="/mysql-9.7/dev/quickstart">
