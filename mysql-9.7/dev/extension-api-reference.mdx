...
see [Creating Extensions in C++](/mysql-9.7/dev/create). For custom column types,
see [Custom Types in C++](/mysql-9.7/dev/custom-types).
...
[Per-Statement State](/mysql-9.7/dev/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/mysql-9.7/dev/development#aggregate-vdfs) for the
...
For the full preview API documentation, see [Preview Capabilities](/mysql-9.7/dev/preview-capabilities).
