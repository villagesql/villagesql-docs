...
<Info>
  Your server must have `veb_dir` configured before you can install external extensions. See [Configuring veb_dir](/mysql-9.7/dev/managing#configuring-veb_dir).
</Info>
...
For more troubleshooting, see [Managing Extensions](/mysql-9.7/dev/managing).
