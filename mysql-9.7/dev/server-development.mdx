...
This guide covers debugging, running the server test suite, and contributing to VillageSQL. It assumes a working source build — see [Build from Source](/mysql-9.7/dev/source) if you haven't done that yet.
...
For writing extension regression tests, see the [Development Guide](/mysql-9.7/dev/development).
