...
<Note>
If you prefer C++, see [Creating Extensions in C++](/mysql-9.7/dev/create) for the C++ SDK walkthrough.
</Note>
...
Before you begin, build VillageSQL from source — extensions link against the server's build tree. Follow the [Build from Source](/mysql-9.7/dev/source) guide first.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shapes"
    href="/mysql-9.7/dev/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="flask"
    href="/mysql-9.7/dev/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/mysql-9.7/dev/testing-network"
  >
