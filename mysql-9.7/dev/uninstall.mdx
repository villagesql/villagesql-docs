...
<Note>
  ...
  fallback). See [Required Privilege](/mysql-9.7/dev/install#required-privilege).
</Note>
...
<Note>
  ...
  action. See [Managing Extensions](/mysql-9.7/dev/managing) for how
...
See [Installing Extensions](/mysql-9.7/dev/install) for details.
