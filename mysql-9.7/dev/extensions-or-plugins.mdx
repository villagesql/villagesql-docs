...
The C++ SDK is more complete today (aggregates, varargs, mysql_services, sql_query, statement_event, column storage); the Rust SDK covers functions (including prerun/postrun state), custom types, and four preview capabilities (status_var, sys_var, thread_worker, keyring) — see [Preview Capabilities in Rust](/mysql-9.7/dev/rust-preview-capabilities).
