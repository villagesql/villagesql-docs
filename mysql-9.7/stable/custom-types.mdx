...
page is Step 4 of the [Creating Extensions in C++](/mysql-9.7/stable/create)
...
See [Type Operations](/mysql-9.7/stable/type-operations) for the full C++ signatures.
...
See [vsql_complex Example](/mysql-9.7/stable/examples) for the complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="hammer"
    href="/mysql-9.7/stable/create#step-5-update-build-configuration"
  >
  ...
  <Card
    ...
    icon="sliders"
    href="/mysql-9.7/stable/type-operations#parameterized-types"
  >
  ...
  <Card
    ...
    icon="book"
    href="/mysql-9.7/stable/extension-api-reference"
  >
  ...
  <Card
    ...
    href="/mysql-9.7/stable/managing#replication"
  >
