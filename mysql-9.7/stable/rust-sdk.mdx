...
<Note>
If you prefer C++, see [Creating Extensions in C++](/mysql-9.7/stable/create) for the C++ SDK walkthrough.
</Note>
...
Before you begin, build VillageSQL from source — extensions link against the server's build tree. Follow the [Build from Source](/mysql-9.7/stable/source) guide first.
...
Edit `Cargo.toml` to set the crate type:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shapes"
    href="/mysql-9.7/stable/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="flask"
    href="/mysql-9.7/stable/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/mysql-9.7/stable/testing-network"
  >
