...
| Custom data types and operators | Register a new base type with its own storage and comparison behaviour | **Available** — see [Custom Types](/mysql-9.7/stable/custom-types) |
| Aggregate functions | Register a user-defined aggregate | **Available** — `make_aggregate_func`, see [Development Guide](/mysql-9.7/stable/development) |
