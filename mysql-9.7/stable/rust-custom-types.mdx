...
This page assumes you've already worked through [Creating Extensions in Rust](/mysql-9.7/stable/rust-sdk). The setup (Cargo.toml, manifest.json, cargo-vsql) is the same.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="wrench"
    href="/mysql-9.7/stable/rust-sdk"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/mysql-9.7/stable/custom-types"
  >
