...
<Info>
  Your server must have `veb_dir` configured before you can install external extensions. See [Configuring veb_dir](/mysql-9.7/stable/managing#configuring-veb_dir).
</Info>
...
For more troubleshooting, see [Managing Extensions](/mysql-9.7/stable/managing).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="sliders"
    href="/mysql-9.7/stable/managing"
  >
  ...
  <Card
    ...
    icon="list"
    href="/mysql-9.7/stable/extensions"
  >
