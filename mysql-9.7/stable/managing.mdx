...
Both names must be identical, using underscores (see [Extension Naming Conventions](/mysql-9.7/stable/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
<Note>
  ...
  [Required Privilege](/mysql-9.7/stable/install#required-privilege).
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book"
    href="/mysql-9.7/stable/reference"
  >
  ...
  <Card
    ...
    icon="trash"
    href="/mysql-9.7/stable/uninstall"
  >
