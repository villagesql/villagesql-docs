...
version change. See [Managing Extensions](/mysql-9.7/stable/managing) for the workflow.
...
Only a single directory is supported. See [Managing Extensions](/mysql-9.7/stable/managing) for placement and troubleshooting.
...
[Type Operations](/mysql-9.7/stable/type-operations) and
[Creating Extensions in C++](/mysql-9.7/stable/create) for what each protocol
version enables.
...
See [Preview Capabilities](/mysql-9.7/stable/preview-capabilities) for the list of
