...
This page is the reference for the C++ type operation builders. For the tutorial-level introduction to custom types, see [Custom Types in C++](/mysql-9.7/stable/custom-types).
...
- [Custom Types in C++](/mysql-9.7/stable/custom-types) — tutorial introduction to custom types
- [C++ API Reference](/mysql-9.7/stable/extension-api-reference) — VDF contracts, null handling, and buffer sizing
- [C++ Development](/mysql-9.7/stable/development) — VDF authoring depth, argument and result types, aggregates, varargs
