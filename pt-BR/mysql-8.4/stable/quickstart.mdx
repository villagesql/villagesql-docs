...
`INSTALL EXTENSION <name>` procura por `<name>.veb` no diretório VEB do servidor — execute `SHOW VARIABLES LIKE 'veb_dir';` para ver onde ele fica. As extensões de exemplo já vêm colocadas lá, então você não precisa copiar nada.
