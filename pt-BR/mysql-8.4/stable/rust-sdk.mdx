...
<Warning>
  ...
  armazenamento em colunas são exclusivos de C++ hoje — use o
  [SDK C++](/pt-BR/mysql-8.4/stable/create) se você precisar de algum deles.
</Warning>

<Note>
Se você prefere C++, consulte [Criando Extensões em C++](/pt-BR/mysql-8.4/stable/create) para o guia passo a passo do SDK C++.
</Note>
...
Antes de começar, compile o VillageSQL a partir do código-fonte — as extensões são vinculadas à árvore de compilação do servidor. Siga primeiro o guia [Compilar a Partir do Código-Fonte](/pt-BR/mysql-8.4/stable/source).
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="flask"
    href="/pt-BR/mysql-8.4/stable/rust-preview-capabilities"
  >
    Variáveis de status, variáveis de sistema, thread workers em segundo plano e
    acesso ao keyring por meio da lista requires:.
  </Card>
  <Card
  ...
  <Card
    ...
    icon="network-wired"
    href="/pt-BR/mysql-8.4/stable/testing-network"
  >
