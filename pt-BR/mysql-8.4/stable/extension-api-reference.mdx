...
consulte [Criando Extensões em C++](/pt-BR/mysql-8.4/stable/create). Para tipos de coluna personalizados,
consulte [Tipos Personalizados em C++](/pt-BR/mysql-8.4/stable/custom-types).
...
[Estado por Instrução](/pt-BR/mysql-8.4/stable/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/pt-BR/mysql-8.4/stable/development#aggregate-vdfs) para a
...
Para a documentação completa da API Preview, consulte [Capabilities Preview](/pt-BR/mysql-8.4/stable/preview-capabilities).
