...
As implementações de VDF do Protocol 1 podem passar as structs C brutas diretamente em vez de usar wrappers tipados. Este estilo continua com suporte, mas provavelmente será descontinuado em uma versão futura — use a [API tipada de argumento/resultado](/pt-BR/mysql-8.4/stable/development#argument-and-result-types) para todo código novo.
