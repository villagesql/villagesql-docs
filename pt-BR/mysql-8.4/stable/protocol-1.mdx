...
As implementações de VDF do Protocol 1 podem passar as structs C brutas diretamente em vez de usar wrappers tipados. Este estilo será removido após a 0.0.5 — use a [API tipada de argumento/resultado](/pt-BR/mysql-8.4/stable/development#argument-and-result-types) para todo código novo.
