...
Antes de começar, compile o VillageSQL a partir do código-fonte — extensões são vinculadas aos cabeçalhos do SDK e à árvore de compilação do servidor. Siga primeiro o guia [Compilar a Partir do Código-Fonte](/pt-BR/mysql-8.4/stable/source).
