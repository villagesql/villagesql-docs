...
consulte [Operações de Tipo](/pt-BR/mysql-8.4/0.0.5/type-operations) e
[Criando Extensões em C++](/pt-BR/mysql-8.4/0.0.5/create) para saber o que
...
Veja [Capabilities Preview](/pt-BR/mysql-8.4/0.0.5/preview-capabilities) para
