...
Para a interface binária completa (structs, typedefs de ponteiros de função e versionamento de protocolo), consulte [`villagesql/sdk/include/villagesql/abi/types.h`](https://github.com/villagesql/villagesql-server/blob/main/villagesql/sdk/include/villagesql/abi/types.h) no repositório do servidor.
