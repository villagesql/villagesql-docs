...
consulte [Criando Extensões em C++](/pt-BR/mysql-9.7/dev/create). Para tipos de coluna personalizados,
consulte [Tipos Personalizados em C++](/pt-BR/mysql-9.7/dev/custom-types).
...
[Estado por Instrução](/pt-BR/mysql-9.7/dev/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/pt-BR/mysql-9.7/dev/development#aggregate-vdfs) para a
...
Para a documentação completa da API Preview, consulte [Capabilities Preview](/pt-BR/mysql-9.7/dev/preview-capabilities).
