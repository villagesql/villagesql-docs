...
Esta página é a referência dos construtores de operações de tipo em C++. Para a introdução em nível de tutorial aos tipos personalizados, consulte [Tipos Personalizados em C++](/pt-BR/mysql-9.7/dev/custom-types).
...
- [Tipos Personalizados em C++](/pt-BR/mysql-9.7/dev/custom-types) — introdução em nível de tutorial aos tipos personalizados
- [Referência da API C++](/pt-BR/mysql-9.7/dev/extension-api-reference) — contratos de VDF, tratamento de null e dimensionamento de buffer
- [Desenvolvimento em C++](/pt-BR/mysql-9.7/dev/development) — profundidade de autoria de VDF, tipos de argumento e resultado, agregados, varargs
