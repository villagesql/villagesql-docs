...
| `vsql::preview::index_profile` | `<villagesql/preview/index_builder.h>` | Preview — consulte [Índices Personalizados](/pt-BR/mysql-9.7/dev/custom-indexes) |
| `vsql::preview::index_type` | `<villagesql/preview/index_builder.h>` | Preview — consulte [Índices Personalizados](/pt-BR/mysql-9.7/dev/custom-indexes) |
