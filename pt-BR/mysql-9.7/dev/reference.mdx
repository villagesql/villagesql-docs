...
Consulte [Gerenciando Extensões](/pt-BR/mysql-9.7/dev/managing) para conhecer o fluxo de trabalho.
...
Apenas um único diretório é compatível. Consulte [Gerenciando Extensões](/pt-BR/mysql-9.7/dev/managing) para posicionamento e solução de problemas.
...
consulte [Operações de Tipo](/pt-BR/mysql-9.7/dev/type-operations) e
[Criando Extensões em C++](/pt-BR/mysql-9.7/dev/create) para saber o que
...
Veja [Capabilities Preview](/pt-BR/mysql-9.7/dev/preview-capabilities) para
