...
- [Testes em C++](/pt-BR/mysql-9.7/dev/testing) — configuração do MTR, execução de suítes, registro de resultados e depuração de falhas
- [Criando Extensões em C++](/pt-BR/mysql-9.7/dev/create) — passos completos de compilação e configuração do CMake
- [Desenvolvimento em C++](/pt-BR/mysql-9.7/dev/development) — criação de VDF, tipos de argumento e tratamento de resultados
