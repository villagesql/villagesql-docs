...
<Warning>
  ...
  exclusivos de C++ hoje — use o [Criando Extensões em C++](/pt-BR/mysql-9.7/dev/create) se você
...
Esta página pressupõe que você já tenha trabalhado com [Criando Extensões em Rust](/pt-BR/mysql-9.7/dev/rust-sdk). A configuração (Cargo.toml, manifest.json, cargo-vsql) é a mesma.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="wrench"
    href="/pt-BR/mysql-9.7/dev/rust-sdk"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/pt-BR/mysql-9.7/dev/custom-types"
  >
