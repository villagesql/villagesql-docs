...
<Note>
Se você prefere C++, consulte [Criando Extensões em C++](/pt-BR/mysql-9.7/stable/create) para o guia passo a passo do SDK C++.
</Note>
...
Antes de começar, compile o VillageSQL a partir do código-fonte — as extensões são vinculadas à árvore de compilação do servidor. Siga primeiro o guia [Compilar a Partir do Código-Fonte](/pt-BR/mysql-9.7/stable/source).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shapes"
    href="/pt-BR/mysql-9.7/stable/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="flask"
    href="/pt-BR/mysql-9.7/stable/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/pt-BR/mysql-9.7/stable/testing-network"
  >
