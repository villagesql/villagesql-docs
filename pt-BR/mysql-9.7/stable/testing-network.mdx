...
- [Testes em C++](/pt-BR/mysql-9.7/stable/testing) — configuração do MTR, execução de suítes, registro de resultados e depuração de falhas
- [Criando Extensões em C++](/pt-BR/mysql-9.7/stable/create) — passos completos de compilação e configuração do CMake
- [Desenvolvimento em C++](/pt-BR/mysql-9.7/stable/development) — criação de VDF, tipos de argumento e tratamento de resultados
