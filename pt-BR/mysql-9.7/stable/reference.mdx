...
Consulte [Gerenciando Extensões](/pt-BR/mysql-9.7/stable/managing) para conhecer o fluxo de trabalho.
...
Apenas um único diretório é compatível. Consulte [Gerenciando Extensões](/pt-BR/mysql-9.7/stable/managing) para posicionamento e solução de problemas.
...
consulte [Operações de Tipo](/pt-BR/mysql-9.7/stable/type-operations) e
[Criando Extensões em C++](/pt-BR/mysql-9.7/stable/create) para saber o que
...
Veja [Capabilities Preview](/pt-BR/mysql-9.7/stable/preview-capabilities) para
