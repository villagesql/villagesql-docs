...
[Capabilities Preview](/pt-BR/mysql-9.7/stable/preview-capabilities).
...
Consulte [Habilitando o Nível Preview](/pt-BR/mysql-9.7/stable/preview-capabilities#enabling-the-preview-tier)
...
a passo [Criando Extensões em Rust](/pt-BR/mysql-9.7/stable/rust-sdk) cobre a
...
hoje. Use o [SDK C++](/pt-BR/mysql-9.7/stable/preview-capabilities) se você
...
<CardGroup cols={2}>
  <Card
    ...
    icon="flask"
    href="/pt-BR/mysql-9.7/stable/preview-capabilities"
  >
