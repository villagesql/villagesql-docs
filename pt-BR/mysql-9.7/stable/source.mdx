...
Para depuração com GDB, execução de testes e contribuição para a base de código do servidor, consulte o [Guia de Desenvolvimento do Servidor](/pt-BR/mysql-9.7/stable/server-development).
...
<CardGroup cols={3}>
  ...
  <Card
    title="Introdução"
    icon="rocket"
    href="/pt-BR/mysql-9.7/stable/index"
  >
