...
<Warning>
  ...
  o [SDK C++](/pt-BR/mysql-9.7/stable/create) se você precisar dela.
</Warning>
...
Esta página pressupõe que você já tenha trabalhado com [Criando Extensões em Rust](/pt-BR/mysql-9.7/stable/rust-sdk). A configuração (Cargo.toml, manifest.json, cargo-vsql) é a mesma.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book"
    href="/pt-BR/mysql-9.7/stable/rust-api-reference"
  >
  ...
  <Card
    ...
    icon="wrench"
    href="/pt-BR/mysql-9.7/stable/rust-sdk"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/pt-BR/mysql-9.7/stable/custom-types"
  >
