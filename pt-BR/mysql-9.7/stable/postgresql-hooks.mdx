...
| Tipos de dados e operadores personalizados | Registra um novo tipo base com seu próprio armazenamento e comportamento de comparação | **Disponível** — consulte [Tipos Personalizados em C++](/pt-BR/mysql-9.7/stable/custom-types) |
| Funções de agregação | Registra uma agregação definida pelo usuário | **Disponível** — `make_aggregate_func`, consulte [Desenvolvimento em C++](/pt-BR/mysql-9.7/stable/development) |
