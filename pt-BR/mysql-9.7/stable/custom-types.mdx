...
de agregação. Esta página é o Passo 4 do tutorial [Criando Extensões em C++](/pt-BR/mysql-9.7/stable/create).
...
Consulte [Operações de Tipo](/pt-BR/mysql-9.7/stable/type-operations) para as assinaturas C++ completas.
...
Consulte [Exemplo vsql_complex](/pt-BR/mysql-9.7/stable/examples) para a implementação completa.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="hammer"
    href="/pt-BR/mysql-9.7/stable/create#step-5-update-build-configuration"
  >
  ...
  <Card
    ...
    icon="sliders"
    href="/pt-BR/mysql-9.7/stable/type-operations#parameterized-types"
  >
  ...
  <Card
    ...
    icon="book"
    href="/pt-BR/mysql-9.7/stable/extension-api-reference"
  >
  ...
  <Card
    ...
    href="/pt-BR/mysql-9.7/stable/managing#replication"
  >
