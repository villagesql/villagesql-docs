...
Both names must be identical, using underscores (see [Extension Naming Conventions](/mysql-8.4/0.0.4-dev/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
services:
  villagesql:
    ...
    ports:
      - "3306:3306"
    volumes:
      - ./extensions:/var/lib/villagesql/extensions
    command: --veb_dir=/var/lib/villagesql/extensions
```
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="trash"
    href="/mysql-8.4/0.0.4-dev/uninstall"
  >
