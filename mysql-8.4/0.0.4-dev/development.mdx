...
<Warning>
VEF Protocol 3 is stable as of v0.0.4. Protocol 4 is under development and is what the current SDK declares. Extensions built against the old Protocol 2 are rejected by the server and must be rebuilt — see [Breaking Changes](/mysql-8.4/0.0.4-dev/breaking-changes).
</Warning>
