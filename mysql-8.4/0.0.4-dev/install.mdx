...
<Info>
  Your server must have `veb_dir` configured before you can install external extensions. See [Configuring veb_dir](/mysql-8.4/0.0.4-dev/managing#configuring-veb_dir).
</Info>
...
For more troubleshooting, see [Managing Extensions](/mysql-8.4/0.0.4-dev/managing).
