...
<Warning>
  ...
  the old Protocol 2 are rejected by the server and must be rebuilt.
</Warning>
...
See [Type Operation Builders](/mysql-8.4/0.0.4-dev/development#type-operation-builders) for the full C++ signatures.
