...
[Type Operations](/mysql-8.4/0.0.5/type-operations) and
[Creating Extensions in C++](/mysql-8.4/0.0.5/create) for what each protocol
version enables.
...
See [Preview Capabilities](/mysql-8.4/0.0.5/preview-capabilities) for the list of
