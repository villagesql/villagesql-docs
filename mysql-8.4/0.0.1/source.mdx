...
**Linux:**
```bash
cmake ~/villagesql-server -DWITH_DEBUG=1 -DCMAKE_INSTALL_PREFIX=~/mysql
```
...
For more detailed information on writing your own tests, debugging failures, and test file syntax, see the [Development Guide](/mysql-8.4/0.0.1/development).
