...
Only a single directory is supported. See [Managing Extensions](/mysql-8.4/0.0.3/managing) for placement and troubleshooting.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="sitemap"
    href="/mysql-8.4/0.0.3/architecture"
  >
