...
All three names must be identical, using underscores (see [Extension Naming Conventions](/mysql-8.4/0.0.3/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="trash"
    href="/mysql-8.4/0.0.3/uninstall"
  >
