...
Protocol 1 VDF implementations can pass the raw C structs directly instead of using typed wrappers. This style remains supported but is likely to be deprecated in a future release — use the [typed argument/result API](/mysql-8.4/dev/development#argument-and-result-types) for all new code.
