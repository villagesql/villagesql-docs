...
Both names must be identical, using underscores (see [Extension Naming Conventions](/mysql-8.4/dev/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
<Note>
  ...
  [Required Privilege](/mysql-8.4/dev/install#required-privilege).
</Note>
