...
version change. See [Managing Extensions](/mysql-8.4/dev/managing) for the workflow.
...
Only a single directory is supported. See [Managing Extensions](/mysql-8.4/dev/managing) for placement and troubleshooting.
...
-- Example output: mysql-8.4_0.0.7-dev
...
[Type Operations](/mysql-8.4/dev/type-operations) and
[Creating Extensions in C++](/mysql-8.4/dev/create) for what each protocol
version enables.
...
See [Preview Capabilities](/mysql-8.4/dev/preview-capabilities) for the list of
