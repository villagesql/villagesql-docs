...
version change. See [Managing Extensions](/mysql-8.4/0.0.6-dev/managing) for the workflow.
...
Only a single directory is supported. See [Managing Extensions](/mysql-8.4/0.0.6-dev/managing) for placement and troubleshooting.
