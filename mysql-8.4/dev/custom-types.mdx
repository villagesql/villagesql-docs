...
page is Step 4 of the [Creating Extensions in C++](/mysql-8.4/dev/create)
...
See [Type Operations](/mysql-8.4/dev/type-operations) for the full C++ signatures.
...
See [vsql_complex Example](/mysql-8.4/dev/examples) for the complete implementation.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="hammer"
    href="/mysql-8.4/dev/create#step-5-update-build-configuration"
  >
  ...
  <Card
    ...
    icon="sliders"
    href="/mysql-8.4/dev/type-operations#parameterized-types"
  >
  ...
  <Card
    ...
    icon="book"
    href="/mysql-8.4/dev/extension-api-reference"
  >
  ...
  <Card
    ...
    href="/mysql-8.4/dev/managing#replication"
  >
