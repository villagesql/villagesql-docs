...
<Warning>
  ...
  C++-only today — use the [C++ SDK](/mysql-8.4/0.0.6-dev/create) if you
  need any of those.
</Warning>

<Note>
If you prefer C++, see [Creating Extensions in C++](/mysql-8.4/0.0.6-dev/create) for the C++ SDK walkthrough.
</Note>
...
Before you begin, build VillageSQL from source — extensions link against the server's build tree. Follow the [Build from Source](/mysql-8.4/0.0.6-dev/source) guide first.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shapes"
    href="/mysql-8.4/0.0.6-dev/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="book"
    href="/mysql-8.4/0.0.6-dev/rust-api-reference"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/mysql-8.4/0.0.6-dev/testing-network"
  >
