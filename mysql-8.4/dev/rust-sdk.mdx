...
This walkthrough builds a single scalar function. Two worked examples in the [vsql-rust-sdk](https://github.com/villagesql/vsql-rust-sdk) repo cover aggregate and varargs support instead:
