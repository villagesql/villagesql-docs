...
title: "Introduction"
description: "Welcome to VillageSQL Server for MySQL 8.4.11-0.0.6-dev"
---
...
This version of VillageSQL is compatible with MySQL 8.4.11.

**<u> VillageSQL Server version 0.0.6-dev is in DEVELOPMENT. PLEASE DO NOT USE IN PRODUCTION</u>**
...
<CardGroup cols={1}>
  <Card title="Quickstart Guide" icon="bolt" href="/mysql-8.4/dev/quickstart">
