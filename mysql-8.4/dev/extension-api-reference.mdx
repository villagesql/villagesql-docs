...
see [Creating Extensions in C++](/mysql-8.4/dev/create). For custom column types,
see [Custom Types in C++](/mysql-8.4/dev/custom-types).
...
[Per-Statement State](/mysql-8.4/dev/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/mysql-8.4/dev/development#aggregate-vdfs) for the
...
For the full preview API documentation, see [Preview Capabilities](/mysql-8.4/dev/preview-capabilities).
