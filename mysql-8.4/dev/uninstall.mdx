...
<Note>
  ...
  fallback). See [Required Privilege](/mysql-8.4/0.0.6-dev/install#required-privilege).
</Note>
...
<Note>
  ...
  action. See [Managing Extensions](/mysql-8.4/0.0.6-dev/managing) for how
...
See [Installing Extensions](/mysql-8.4/0.0.6-dev/install) for details.
