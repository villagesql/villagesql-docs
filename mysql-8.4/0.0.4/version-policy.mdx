...
**Protocol 2 extensions must be rebuilt.** VEF Protocol 3 is stable as of v0.0.4, and the server now rejects Protocol 2 extensions at load time. Rebuild against the 0.0.4 SDK using the typed wrapper API (`StringArg`, `IntArg`, `StringResult`, etc.).
