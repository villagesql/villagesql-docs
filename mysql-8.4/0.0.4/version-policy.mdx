...
**Protocol 2 extensions are rejected.** VEF Protocol 3 is stable as of v0.0.4. The server rejects extensions built against Protocol 2 — rebuild against the 0.0.4 SDK using the Protocol 3 typed wrapper API (`StringArg`, `IntArg`, `StringResult`, etc.).
