...
Both names must be identical, using underscores (see [Extension Naming Conventions](/mysql-8.4/0.0.4/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
<Note>
  **ALTER EXTENSION UPDATE** is not yet supported and is planned for a future release.
</Note>
