...
This page is a reference for the `villagesql` crate API. For the getting started tutorial, see [Building Extensions in Rust](/mysql-8.4/0.0.4/rust-sdk). For custom types, see [Custom Types in Rust](/mysql-8.4/0.0.4/rust-custom-types).
