...
This page assumes you've already worked through [Building Extensions in Rust](/mysql-8.4/0.0.4/rust-sdk). The setup (Cargo.toml, manifest.json, cargo-vsql) is the same.
