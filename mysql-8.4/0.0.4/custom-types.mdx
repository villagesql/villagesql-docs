...
page is Step 4 of the [Creating Extensions](/mysql-8.4/0.0.4/create)
...
See [Type Operation Builders](/mysql-8.4/0.0.4/development#type-operation-builders) for the full C++ signatures.
...
See [vsql_complex Example](/mysql-8.4/0.0.4/examples) for the complete implementation.
