...
This guide covers GDB debugging, running the server test suite, and contributing to VillageSQL. Start with [Build from Source](/mysql-8.4/0.0.4/source) to get a working build before using this guide.
...
For writing extension regression tests, see the [Development Guide](/mysql-8.4/0.0.4/development).
