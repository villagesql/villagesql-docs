...
see [Creating Extensions](/mysql-8.4/0.0.4/create). For custom column types,
see [Creating Custom Types](/mysql-8.4/0.0.4/custom-types).
...
[Per-Statement State](/mysql-8.4/0.0.4/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/mysql-8.4/0.0.4/development#aggregate-vdfs) for the
...
For the full preview API documentation, see [Preview Capabilities](/mysql-8.4/0.0.4/preview-capabilities).
