...
This guide covers writing VDF implementations and running regression tests for VillageSQL extensions. It is the companion to [Creating Extensions](/mysql-8.4/0.0.4/create), which covers the end-to-end build steps.
...
<Note>
  If you are contributing to the VillageSQL server itself (not building an extension), see [Build from Source](/mysql-8.4/0.0.4/source), which covers the full server developer workflow including running tests with `mysql-test-run.pl` directly.
</Note>

## Setting Up Your Environment

To develop and test extensions, you need a built VillageSQL server. Follow the [Clone and Build from Source](/mysql-8.4/0.0.4/source) guide to compile the server binaries.
...
<Warning>
  ...
  [Preview Capabilities](/mysql-8.4/0.0.4/preview-capabilities#system-variables)
...
<Warning>
  ...
  development and subject to change before the beta release. See
  [Preview Capabilities](/mysql-8.4/0.0.4/preview-capabilities#status-variables)
  for the full reference.
</Warning>
...
[Preview Capabilities](/mysql-8.4/0.0.4/preview-capabilities#keyring-access)
for the full API reference, result codes, and a complete example.

### Column Storage

Column storage is a preview capability — see
[Preview Capabilities](/mysql-8.4/0.0.4/preview-capabilities#column-storage)
...
- [Creating Extensions](/mysql-8.4/0.0.4/create) — end-to-end build steps, CMake setup, and installation
- [Extension API Reference](/mysql-8.4/0.0.4/extension-api-reference) — VDF contracts, null handling, and buffer sizing
- [Extension Architecture](/mysql-8.4/0.0.4/architecture) — lifecycle, Victionary caching, performance patterns, and security model
