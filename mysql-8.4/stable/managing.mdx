...
Both names must be identical, using underscores (see [Extension Naming Conventions](/mysql-8.4/stable/install#extension-naming-conventions)):
- VEB filename: `my_extension.veb`
...
<Note>
  ...
  [Required Privilege](/mysql-8.4/stable/install#required-privilege).
</Note>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book"
    href="/mysql-8.4/stable/reference"
  >
  ...
  <Card
    ...
    icon="trash"
    href="/mysql-8.4/stable/uninstall"
  >
