...
<Note>
  ...
  fallback). See [Required Privilege](/mysql-8.4/stable/install#required-privilege).
</Note>
...
<Note>
  ...
  action. See [Managing Extensions](/mysql-8.4/stable/managing) for how
...
See [Installing Extensions](/mysql-8.4/stable/install) for details.
