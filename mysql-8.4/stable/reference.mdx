...
version change. See [Managing Extensions](/mysql-8.4/stable/managing) for the workflow.
...
Only a single directory is supported. See [Managing Extensions](/mysql-8.4/stable/managing) for placement and troubleshooting.
...
[Type Operations](/mysql-8.4/stable/type-operations) and
[Creating Extensions in C++](/mysql-8.4/stable/create) for what each protocol
version enables.
...
See [Preview Capabilities](/mysql-8.4/stable/preview-capabilities) for the list of
