...
This page is the reference for the C++ type operation builders. For the tutorial-level introduction to custom types, see [Custom Types in C++](/mysql-8.4/stable/custom-types).
...
- [Custom Types in C++](/mysql-8.4/stable/custom-types) — tutorial introduction to custom types
- [C++ API Reference](/mysql-8.4/stable/extension-api-reference) — VDF contracts, null handling, and buffer sizing
- [C++ Development](/mysql-8.4/stable/development) — VDF authoring depth, argument and result types, aggregates, varargs
