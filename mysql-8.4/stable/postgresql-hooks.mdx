...
| Custom data types and operators | Register a new base type with its own storage and comparison behaviour | **Available** — see [Custom Types](/mysql-8.4/stable/custom-types) |
| Aggregate functions | Register a user-defined aggregate | **Available** — `make_aggregate_func`, see [Development Guide](/mysql-8.4/stable/development) |
