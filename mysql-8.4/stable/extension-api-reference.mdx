...
see [Creating Extensions in C++](/mysql-8.4/stable/create). For custom column types,
see [Custom Types in C++](/mysql-8.4/stable/custom-types).
...
[Per-Statement State](/mysql-8.4/stable/development#per-statement-state-prerun-and-postrun)
...
[Aggregate VDFs](/mysql-8.4/stable/development#aggregate-vdfs) for the
...
For the full preview API documentation, see [Preview Capabilities](/mysql-8.4/stable/preview-capabilities).
