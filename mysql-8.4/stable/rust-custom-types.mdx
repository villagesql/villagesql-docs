...
This page assumes you've already worked through [Creating Extensions in Rust](/mysql-8.4/0.0.5/rust-sdk). The setup (Cargo.toml, manifest.json, cargo-vsql) is the same.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book"
    href="/mysql-8.4/0.0.5/rust-api-reference"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/mysql-8.4/0.0.5/custom-types"
  >
