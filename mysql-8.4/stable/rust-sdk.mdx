...
<Note>
If you prefer C++, see [Creating Extensions in C++](/mysql-8.4/stable/create) for the C++ SDK walkthrough.
</Note>
...
Before you begin, build VillageSQL from source — extensions link against the server's build tree. Follow the [Build from Source](/mysql-8.4/stable/source) guide first.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="shapes"
    href="/mysql-8.4/stable/rust-custom-types"
  >
  ...
  <Card
    ...
    icon="flask"
    href="/mysql-8.4/stable/rust-preview-capabilities"
  >
  ...
  <Card
    ...
    icon="network-wired"
    href="/mysql-8.4/stable/testing-network"
  >
