...
For development or custom builds, follow the [Clone and Build from Source Guide](/mysql-8.4/0.0.5-dev/source) to compile from the latest code.
...
For more details, see [Installing Extensions](/mysql-8.4/0.0.5-dev/install).
...
<CardGroup cols={2}>
  <Card title="Managing Extensions" icon="puzzle-piece" href="/mysql-8.4/0.0.5-dev/managing">
    Learn how to install and manage other extensions.
  </Card>
  <Card title="Create an Extension" icon="code" href="/mysql-8.4/0.0.5-dev/create">
