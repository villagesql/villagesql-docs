...
This page is a reference for the `villagesql` crate API. For the getting started tutorial, see [Building Extensions in Rust](/mysql-8.4/0.0.5-dev/rust-sdk). For custom types, see [Custom Types in Rust](/mysql-8.4/0.0.5-dev/rust-custom-types).
