...
<Warning>
  The Rust SDK is at version 0.0.1 — expect breaking API changes between
...
This page assumes you've already worked through [Creating Extensions in Rust](/mysql-8.4/0.0.5-dev/rust-sdk). The setup (Cargo.toml, manifest.json, cargo-vsql) is the same.
