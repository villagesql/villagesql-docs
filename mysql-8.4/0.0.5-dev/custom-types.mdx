...
See [Type Operation Builders](/mysql-8.4/0.0.5-dev/development#type-operation-builders) for the full C++ signatures.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="sliders"
    href="/mysql-8.4/0.0.5-dev/development#parameterized-types"
  >
