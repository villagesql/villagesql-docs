---
title: "C++ Development"
description: "Writing extension functions and running tests for your VillageSQL extension in C++."
---

This guide covers writing C++ VDF implementations and running regression tests for VillageSQL extensions. It is the companion to [Creating Extensions in C++](/mysql-8.4/0.0.5-dev/create), which covers the end-to-end build steps.
