---
title: "Introduction"
description: "Welcome to VillageSQL Server for MySQL 8.4.9-0.0.5-dev"
---
...
**<u> VillageSQL Server version 0.0.5-dev is in DEVELOPMENT. PLEASE DO NOT USE IN PRODUCTION</u>**
...
<CardGroup cols={1}>
  <Card title="Quickstart Guide" icon="bolt" href="/mysql-8.4/0.0.5-dev/quickstart">
