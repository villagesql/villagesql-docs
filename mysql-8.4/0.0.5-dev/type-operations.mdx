...
This page is the reference for the C++ type operation builders. For the tutorial-level introduction to custom types, see [Custom Types in C++](/mysql-8.4/0.0.5-dev/custom-types).
...
- [Custom Types in C++](/mysql-8.4/0.0.5-dev/custom-types) — tutorial introduction to custom types
