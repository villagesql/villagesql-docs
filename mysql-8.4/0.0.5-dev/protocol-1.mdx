...
Protocol 1 VDF implementations can pass the raw C structs directly instead of using typed wrappers. This style will be dropped after 0.0.5 — use [typed wrappers](/mysql-8.4/0.0.5-dev/development#typed-wrappers-recommended) for all new code.
