...
This guide covers GDB debugging, running the server test suite, and contributing to VillageSQL. Start with [Build from Source](/mysql-8.4/0.0.5-dev/source) to get a working build before using this guide.
