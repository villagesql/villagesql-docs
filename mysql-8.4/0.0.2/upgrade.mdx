...
- **VillageSQL Binaries**: Ensure you have the VillageSQL binaries ready (either [compiled from source](/mysql-8.4/0.0.2/source) or downloaded).
...
+--------------------------+---------------------+
| 8.4.6-villagesql-0.0.2   | Source distribution |
+--------------------------+---------------------+
```
