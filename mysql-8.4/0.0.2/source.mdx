...
```
8.4.6-villagesql-0.0.3-dev-7df91cf796b
```

Release builds show the version without the git hash:
```
...
For more detailed information on writing your own tests, debugging failures, and test file syntax, see the [Development Guide](/mysql-8.4/0.0.2/development).
