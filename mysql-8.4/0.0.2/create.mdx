...
See [vsql_complex Example](/mysql-8.4/0.0.2/examples) for the complete implementation.
...
<Warning>
Custom aggregate functions (SUM, AVG, etc.) are not yet fully supported in this alpha release. However, COUNT(DISTINCT), MIN, and MAX operations work with custom types.
</Warning>
