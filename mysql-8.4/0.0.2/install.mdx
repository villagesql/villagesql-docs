...
<Note>
  Custom indexes are coming in a future release. COUNT(DISTINCT), MIN, and MAX aggregate operations work with custom types.
</Note>
...
For more troubleshooting, see [Managing Extensions](/mysql-8.4/0.0.2/managing).
