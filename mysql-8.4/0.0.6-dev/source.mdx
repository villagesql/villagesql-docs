...
For GDB debugging, running tests, and contributing to the server codebase, see the [Server Development Guide](/mysql-8.4/0.0.6-dev/server-development).
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="rocket"
    href="/mysql-8.4/0.0.6-dev/index"
  >
