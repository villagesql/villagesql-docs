...
This page assumes you've already worked through [Creating Extensions in Rust](/mysql-8.4/0.0.6-dev/rust-sdk). The setup (Cargo.toml, manifest.json, cargo-vsql) is the same.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="wrench"
    href="/mysql-8.4/0.0.6-dev/rust-sdk"
  >
  ...
  <Card
    ...
    icon="shapes"
    href="/mysql-8.4/0.0.6-dev/custom-types"
  >
