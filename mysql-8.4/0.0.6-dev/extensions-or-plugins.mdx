...
- **C++** — [vsql-extension-template](https://github.com/villagesql/vsql-extension-template) is the starting point. Walk through [Creating Extensions in C++](/mysql-8.4/0.0.6-dev/create).
- **Rust** — [vsql-extension-template-rust](https://github.com/villagesql/vsql-extension-template-rust) is the starting point. Walk through [Creating Extensions in Rust](/mysql-8.4/0.0.6-dev/rust-sdk).
