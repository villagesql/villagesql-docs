...
**Performance:** Function lookup adds negligible overhead (~1-10ns). Qualified calls skip the resolution chain and directly invoke the extension function.
...
-- Expected: '1' for VillageSQL 0.0.3-dev
```
