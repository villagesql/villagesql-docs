...
Before you begin, build VillageSQL from source — extensions link against the server's SDK headers and build tree. Follow the [Clone and Build from Source](/mysql-8.4/0.0.3-dev/source) guide first.
...
For the full naming convention across SQL, filenames, and repository names, see [Extension Naming Conventions](/mysql-8.4/0.0.3-dev/install#extension-naming-conventions).
...
See the [development guide](/mysql-8.4/0.0.3-dev/development#typed-wrappers)
