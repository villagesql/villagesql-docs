...
<CardGroup cols={2}>
  ...
  >
    **UUID data type and functions**
    ...
    UUID generation, validation, and comparison. Supports all 7 UUID versions (v1–v7).
  </Card>
  ...
  >
    **Cryptographic functions**
    ...
    Hashing (MD5–SHA-512), HMAC, AES encryption, and password hashing using OpenSSL.
  </Card>
  ...
  >
    **AI-powered SQL functions**
    ...
    SQL functions for AI prompting and embeddings. Supports Claude, Gemini, and OpenAI.
  </Card>
</CardGroup>
