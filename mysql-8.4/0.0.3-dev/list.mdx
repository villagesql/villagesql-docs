...
**Learn More:** [vsql_complex Deep Dive](/mysql-8.4/0.0.3-dev/examples)
...
**For source builds:** Only `vsql_complex` and `vsql_simple` are included by default. To use external extensions, build them from their GitHub repositories (links above) and copy the `.veb` files to your VEF directory (see [Installing External Extensions](/mysql-8.4/0.0.3-dev/install#installing-external-extensions)).

See [Installing Extensions](/mysql-8.4/0.0.3-dev/install) for detailed instructions.
...
**Get started:** [Creating Extensions Guide](/mysql-8.4/0.0.3-dev/create)
