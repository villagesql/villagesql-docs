...
To develop VillageSQL, you first need to build the server from source. Follow the [Clone and Build from Source](/mysql-8.4/0.0.3-dev/source) guide to clone the repository and compile the binaries.
